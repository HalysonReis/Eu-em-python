...
while terminou:
    ...
    try:
        ...
        print('cara digite apenas os numeros apresentados.')
...
percentual_nulo = voto_nulo / total_votos * 100
percentual_branco = voto_branco / total_votos * 100
